<template>
  <div class="paymentOrdersList-container" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy"
       infinite-scroll-distance="1">
    <order-component :key="index" v-for="(item,index) in orderList" :order="item"
                     class="order-content" @cancelorder="cancelOrderHandler"></order-component>
  </div>
</template>
